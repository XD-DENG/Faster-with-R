...
- Parallel Computing (multil-core)
...
dat <- data.frame(A = 1:1e7,
                  B=sample(letters, 1e7, replace = TRUE),
                  C=sample(LETTERS, 1e7, replace = TRUE),
                  D= rnorm(1e7),
...
Unit: seconds
                                      ...
                                      load("test_dat_B.RData")  6.074962  6.441726  7.720662  7.401062
 dat_1 <- read.csv("test_dat_A.csv", stringsAsFactors = FALSE) 50.497798 52.256679 56.617414 53.872500
                              dat_2 <- fread("test_dat_A.csv")  2.983866  3.371028  4.065156  3.689412
        uq       max neval
  8.949302 10.420226    10
 55.517862 83.598297    10
  4.453677  6.214524    10
```
